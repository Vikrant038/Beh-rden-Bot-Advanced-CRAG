"""
FAISS Vector Search Retrieval Engine with Fine-Tuned BGE 768d Embeddings
...
def get_model_path() -> str:
    fine_tuned = os.path.join(get_project_root(), "models", "bge_base_german_visa_finetuned")
